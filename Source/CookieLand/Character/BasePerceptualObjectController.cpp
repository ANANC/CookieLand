...
#include "BasePerceptualObjectController.h"
#include "EnhancedInputComponent.h"
#include "CookieLand/PerceptualObject/PerceptualObjectInputComponent.h"
#include "GameFramework/Character.h"
#include "GameFramework/CharacterMovementComponent.h"

ABasePerceptualObjectController::ABasePerceptualObjectController()
{
	PerceptualObjectInputComponent = CreateDefaultSubobject<UPerceptualObjectInputComponent>(TEXT("PerceptualObjectInput"));
}

void ABasePerceptualObjectController::SetPawn(APawn* InPawn)
{
	Super::SetPawn(InPawn);
}

void ABasePerceptualObjectController::SetupInputComponent()
{
	Super::SetupInputComponent();

	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(InputComponent))
	{
		PerceptualObjectInputComponent->SetupInputComponent(EnhancedInputComponent);
	}
}

void ABasePerceptualObjectController::UpdateRotation(float DeltaTime)
{
...
FRotator ABasePerceptualObjectController::GetGravityRelativeRotation(FRotator Rotation, FVector GravityDirection)
{
...
FRotator ABasePerceptualObjectController::GetGravityWorldRotation(FRotator Rotation, FVector GravityDirection)
{
	if (!GravityDirection.Equals(FVector::DownVector))
	{
